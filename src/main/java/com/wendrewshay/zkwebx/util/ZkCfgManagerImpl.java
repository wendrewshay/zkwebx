...
//	jdbc:h2:tcp://localhost/~/test
	...
	// 指定JDBC串
	private static JdbcConnectionPool cp = JdbcConnectionPool.create("jdbc:h2:~/zkcfg","h2","h2");
//	private static JdbcConnectionPool cp = JdbcConnectionPool.create("jdbc:h2:tcp://192.168.56.101:19200/~/zkcfg","h2","h2");
	private static Connection conn = null;
	private static QueryRunner run = new QueryRunner(H2Util.getDataSource());
